...
EMAIL_HOST_USER = 'info@json666.cn'    #发送邮件的邮箱地址
EMAIL_HOST_PASSWORD = 'gwj060510JIAYOU'
EMAIL_SUBJECT_PREFIX = u'Json Blog'
...
# 网站标题等内容配置
WEBSITE_TITLE = u'Json Blog'
WEBSITE_WELCOME = u'欢迎来到Json Blog！IT难们，稳住，我们能赢。'
